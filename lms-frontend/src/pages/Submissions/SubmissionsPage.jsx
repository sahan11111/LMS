...
const SubmissionsPage = () => {
  ...
  useEffect(() => { submissionAPI.list().then((r) => setData(r.data.results || r.data)).catch(() => toast.error('Failed')).finally(() => setLoading(false)); }, []);

  const columns = [
    { key: 'id', label: 'ID' },
    { key: 'assessment', label: 'Assessment' },
    { key: 'student', label: 'Student' },
    { key: 'score', label: 'Score', render: (r) => r.score !== null ? r.score : <span className="text-gray-400">Ungraded</span> },
